...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/09 12:15:11 by rverhoev          #+#    #+#             */
/*   Updated: 2024/08/09 12:15:55 by rverhoev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	interpolate(int color_A, int color_B, float t)
{
	...
	return (create_color(rgb_interpolate.rgb[0], \
		rgb_interpolate.rgb[1], rgb_interpolate.rgb[2]));
}
